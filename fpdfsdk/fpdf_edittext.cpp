...
RetainPtr<CPDF_Font> LoadCompositeFont(CPDF_Document* doc,
  ...
  RetainPtr<CPDF_Array> widths_array = CreateWidthsArray(widths);
  doc->AddIndirectObject(widths_array);
  ...
  RetainPtr<CPDF_Stream> to_unicode_stream = LoadUnicode(to_unicode);
  doc->AddIndirectObject(to_unicode_stream);
