...
static_assert(pdfium::FontPitchFamily::kPitchFamilyFixed ==
              FXFONT_FF_FIXEDPITCH);
static_assert(pdfium::FontPitchFamily::kPitchFamilyRoman == FXFONT_FF_ROMAN);
static_assert(pdfium::FontPitchFamily::kPitchFamilyScript == FXFONT_FF_SCRIPT);
