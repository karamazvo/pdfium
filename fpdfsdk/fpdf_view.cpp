...
#if defined(PDF_USE_SKIA)
  CFX_GEModule::SetRendererType(CFX_GEModule::kDefaultRenderer);
#endif
}
...
#if defined(PDF_USE_SKIA)
  CFX_GEModule::RendererType renderer_type = CFX_GEModule::kDefaultRenderer;
...
FPDF_EXPORT int FPDF_CALLCONV FPDFBitmap_GetFormat(FPDF_BITMAP bitmap) {
  ...
  switch (pBitmap->GetFormat()) {
    ...
    case FXDIB_Format::kBgraPremul:
      return CFX_GEModule::UseSkiaRenderer() ? FPDFBitmap_BGRA_Premul
                                             : FPDFBitmap_Unknown;
#endif
    default:
      return FPDFBitmap_Unknown;
