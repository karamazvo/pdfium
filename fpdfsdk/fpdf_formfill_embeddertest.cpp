...
TEST_F(FPDFFormFillEmbedderTest, DoNotHandleShortcutsOnKeyDown) {
  ...
  // Edit shortcuts should not be handled by PDFium so that embedders, such as
  // Chrome can handle these shortcuts on platforms like MacOS which don't send
  // OnChar events for the shortcuts.
  EXPECT_FALSE(
