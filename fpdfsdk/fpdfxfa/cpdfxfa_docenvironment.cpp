...
bool CPDFXFA_DocEnvironment::ExportSubmitFile(
    FPDF_FILEHANDLER* pFileHandler,
    int fileType,
...
void CPDFXFA_DocEnvironment::ToXFAContentFlags(
    WideStringView csSrcContent,
    fxcrt::mask<XfaSubmitOptions>& flags) {
