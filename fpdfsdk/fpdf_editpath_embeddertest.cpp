...
constexpr const char* kRectangleAndTrianglePng = "rectangles_and_triangle";
...
TEST_F(FPDFEditPathEmbedderTest, AddPathToRectangles) {
  ...
  VerifySavedDocumentToPngWithExpectationSuffix(kRectangleAndTrianglePng);
}
