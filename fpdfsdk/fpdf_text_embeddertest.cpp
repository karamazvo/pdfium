...
#define EXPECT_NEAR_FIVE_PLACES(a, b) EXPECT_NEAR((a), (b), 0.00001)
...
<<<<<<< PATCH SET (04706866f8350f5f7579452ca2558a6c66cb276f Macro)
  EXPECT_FLOAT_EQ(kExpectedLooseCharWidth, rect.right - rect.left);
  EXPECT_NEAR_FIVE_PLACES(kExpectedLooseCharHeight, rect.top - rect.bottom);
||||||| BASE      (f99c212599bb85ce2e60936099f829cbcc3d4f5c Replace TEXTPOS defines with a typed enum)
  EXPECT_FLOAT_EQ(kExpectedLooseCharWidth, rect.right - rect.left);
  EXPECT_NEAR(kExpectedLooseCharHeight, rect.top - rect.bottom, 0.00001);
=======
  EXPECT_NEAR(kExpectedLooseCharWidth, rect.right - rect.left, 0.001f);
  EXPECT_NEAR(kExpectedLooseCharHeight, rect.top - rect.bottom, 0.001f);
>>>>>>> BASE      (ff5e04acc96f3e2c6b03aff0477ee8be5f12964f Fix issue with extra tall FPDFText_GetLooseCharBox() results)
...
<<<<<<< PATCH SET (04706866f8350f5f7579452ca2558a6c66cb276f Macro)
  ...
  EXPECT_NEAR_THREE_PLACES(15.912f, rect.top - rect.bottom);
  EXPECT_NEAR_THREE_PLACES(752.422f, rect.top);
||||||| BASE      (f99c212599bb85ce2e60936099f829cbcc3d4f5c Replace TEXTPOS defines with a typed enum)
