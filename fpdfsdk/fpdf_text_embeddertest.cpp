...
void VerifySides(CharBoxPositions expected, CharBoxPositions actual) {
...
void VerifySidesExact(CharBoxPositions expected, CharBoxPositions actual) {
...
TEST_F(FPDFTextEmbedderTest, TextVertical) {
  ...
  EXPECT_TRUE(
      FPDFText_GetCharBox(textpage.get(), 1, &left, &right, &bottom, &top));
#if BUILDFLAG(IS_MAC)
  VerifySides({7.168, 12.808, 178.06, 171.4}, {left, right, top, bottom});
#else
  VerifySides({7.276, 12.808, 178.288, 171.364}, {left, right, top, bottom});
#endif
  EXPECT_TRUE(
      FPDFText_GetCharBox(textpage.get(), 2, &left, &right, &bottom, &top));
#if BUILDFLAG(IS_MAC)
  VerifySides({9.472, 10.528, 169.324, 160.492}, {left, right, top, bottom});
#else
  VerifySides({9.772, 11.56, 170.188, 160.348}, {left, right, top, bottom});
#endif
...
TEST_F(FPDFTextEmbedderTest, WebLinks) {
  ...
  VerifySides({50.828, 187.904, 108.700, 97.516}, {left, right, top, bottom});
  ...
  VerifySides({-1.0, -1.0, -1.0, -1.0}, {left, right, top, bottom});
  ...
  VerifySides({-2.0, -2.0, -2.0, -2.0}, {left, right, top, bottom});
...
TEST_F(FPDFTextEmbedderTest, SmallType3Glyph) {
  ...
  ASSERT_TRUE(
      FPDFText_GetCharBox(text_page.get(), 0, &left, &right, &bottom, &top));
  VerifySidesExact(
      {63.439998626708984, 65.360000610351562, 61.520000457763672, 50},
