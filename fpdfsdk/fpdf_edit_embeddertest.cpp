...
TEST_F(FPDFEditEmbedderTest, GetBitmapWithRgbImageWithPaletteInvalidHival) {
  ASSERT_TRUE(OpenDocument("bug_372749732.pdf"));
  ...
  ScopedFPDFBitmap bitmap(FPDFImageObj_GetBitmap(obj));
  // A bitmap with an invalid hival for the indexed palette can still be
  // acquired.
  ASSERT_TRUE(bitmap);
  CompareBitmap(bitmap.get(), 4, 4, "49b4d39d3fd81c9853b493b615e475d1");
}
