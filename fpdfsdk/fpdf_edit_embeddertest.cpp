...
TEST_F(FPDFEditEmbedderTest, SetPositionsBadParams) {
  ...
  EXPECT_FALSE(FPDFText_SetPositions(nullptr, nullptr, nullptr, 1));
  EXPECT_FALSE(FPDFText_SetPositions(nullptr, kData.data(), kData.data(), 0));
  EXPECT_FALSE(
      FPDFText_SetPositions(nullptr, kData.data(), kData.data(), kData.size()));
  EXPECT_FALSE(FPDFText_SetPositions(page_object, nullptr, nullptr, 0));
  EXPECT_FALSE(FPDFText_SetPositions(page_object, nullptr, nullptr, 1));
  EXPECT_FALSE(
      FPDFText_SetPositions(page_object, kData.data(), nullptr, kData.size()));
  EXPECT_FALSE(
      FPDFText_SetPositions(page_object, nullptr, kData.data(), kData.size()));
  ...
  EXPECT_FALSE(
      FPDFText_SetPositions(page_object, kData.data(), kData.data(), 12));
  EXPECT_FALSE(
      FPDFText_SetPositions(page_object, kData.data(), kData.data(), 14));
