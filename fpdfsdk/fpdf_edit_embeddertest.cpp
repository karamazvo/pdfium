...
const char kRedRectanglePng[] = "red_rectangle.png";
...
TEST_F(FPDFEditEmbedderTest, DoubleGenerating) {
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmapToPng(page_bitmap.get(), "red_rectangle_alpha");
  }
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmapToPng(page_bitmap.get(), "blue_rectangle_alpha");
  }
