...
FPDFImageObj_GetRenderedBitmap(FPDF_DOCUMENT document,
                               FPDF_PAGE page,
                               FPDF_PAGEOBJECT image_object) {
  return FPDFImageObj_GetRenderedBitmapWithBitmapFormat(
      document, page, image_object, FPDFBitmap_BGRA);
}

FPDF_EXPORT FPDF_BITMAP FPDF_CALLCONV
FPDFImageObj_GetRenderedBitmapWithBitmapFormat(FPDF_DOCUMENT document,
                                               FPDF_PAGE page,
                                               FPDF_PAGEOBJECT image_object,
                                               int bitmap_format) {
