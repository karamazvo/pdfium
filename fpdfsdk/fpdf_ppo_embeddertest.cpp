...
TEST_F(FPDFPPOEmbedderTest, XFAMovePage) {
  ...
  const int initial_page_index = 0;
  ...
  std::string checksum_before = EmbedderTest::HashBitmap(bitmap_before.get());
  ...
  std::string checksum_after = EmbedderTest::HashBitmap(bitmap_after.get());
