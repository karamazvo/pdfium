  ...
  if (CPWL_Wnd::IsPlatformShortcutKey(nFlags)) {
    switch (nKeyCode) {
      ...
      case FWL_VKEY_Z:
        ...
        //
        // On MacOS it is necessary to use the Chrome shortcut keys handler,
        // which goes through OnKeyDown. If PDFium returned true for these
        // events it would block the chrome handler.
        return false;
      default:
        break;
    }
