...
TEST(FPDFSysFontInfoTest, Version1Versus2Comparison) {
  // Version 1: Calls EnumFonts upfront, builds font list, then calls MapFont.
  // Version 2: Skips EnumFonts, calls MapFont directly per-request.
  // Both produce same results, but version 2 avoids expensive enumeration.
}
