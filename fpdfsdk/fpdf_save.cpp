...
static_assert(FPDF_INCREMENTAL == CPDF_Creator::SaveFlags::kIncremental);
static_assert(FPDF_NO_INCREMENTAL == CPDF_Creator::SaveFlags::kNoOriginal);
static_assert(FPDF_REMOVE_SECURITY_DEPRECATED ==
              CPDF_Creator::SaveFlags::kRemoveSecurityDeprecated);
static_assert(FPDF_REMOVE_SECURITY == CPDF_Creator::SaveFlags::kRemoveSecurity);
static_assert(FPDF_SUBSET_NEW_FONTS ==
              CPDF_Creator::SaveFlags::kSubsetNewFonts);
...
bool DoDocSave(FPDF_DOCUMENT document,
  ...
  bool create_result =
      file_maker.Create(static_cast<CPDF_Creator::SaveFlags>(flags));
