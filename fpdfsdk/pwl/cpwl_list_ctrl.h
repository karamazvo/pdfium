...
class CPWL_ListCtrl {
 public:
  ...
  CFX_FloatRect GetPlateRect() const { return rc_plate_; }
 ...
 private:
  class Item {
   public:
    ...
    void SetRect(const CFX_FloatRect& rect) { rc_list_item_ = rect; }
    void SetSelect(bool bSelected) { selected_ = bSelected; }
    void SetText(const WideString& text);
    void SetFontSize(float fFontSize);
    WideString GetText() const;

    CFX_FloatRect GetRect() const { return rc_list_item_; }
  ...
  CFX_FloatRect rc_content_;
  CFX_PointF pt_scroll_pos_;
