...
void CPWL_Wnd::Realize() {
  ...
  ccp.dwFlags &= Mask<PStyles>{
      kPwsBorder,          kPwsBackground,   kPwsVScroll,
      kPwsVisible,         kPwsReadOnly,     kPwsAutoFontSize,
      kPwsAutoTransparent, kPwsNoRefreshClip};  // remove sub styles
