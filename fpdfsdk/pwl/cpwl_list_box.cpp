...
void CPWL_ListBox::OnCreated() {
  ...
  SetHoverSel(HasFlag(CPWL_Wnd::Styles::kListboxHoverSel));
  list_ctrl_->SetMultipleSel(HasFlag(CPWL_Wnd::Styles::kListboxMultipleSel));
  list_ctrl_->SetFontSize(GetCreationParams()->fFontSize);

  hover_sel_ = HasFlag(CPWL_Wnd::Styles::kListboxHoverSel);
}
