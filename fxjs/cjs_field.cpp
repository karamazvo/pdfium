...
std::vector<CPDF_FormField*> CJS_Field::GetFormFields() const {
  return GetFormFieldsForName(form_fill_env_.Get(), m_FieldName);
}
...
CJS_Result CJS_Field::set_border_style(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetBorderStyle(form_fill_env_.Get(), m_FieldName, form_control_index_,
                   byte_str);
  }
  return CJS_Result::Success();
}
...
CJS_Result CJS_Field::set_current_value_indices(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetCurrentValueIndices(form_fill_env_.Get(), m_FieldName,
...
CJS_Result CJS_Field::set_display(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetDisplay(form_fill_env_.Get(), m_FieldName, form_control_index_,
               pRuntime->ToInt32(vp));
  }
  return CJS_Result::Success();
}
...
CJS_Result CJS_Field::set_hidden(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetHidden(form_fill_env_.Get(), m_FieldName, form_control_index_,
...
CJS_Result CJS_Field::set_line_width(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetLineWidth(form_fill_env_.Get(), m_FieldName, form_control_index_,
                 pRuntime->ToInt32(vp));
  }
  return CJS_Result::Success();
}
...
CJS_Result CJS_Field::set_rect(CJS_Runtime* pRuntime, v8::Local<v8::Value> vp) {
  ...
  if (delay_) {
    ...
    SetRect(form_fill_env_.Get(), m_FieldName, form_control_index_, crRect);
  }
  return CJS_Result::Success();
}
...
CJS_Result CJS_Field::set_value(CJS_Runtime* pRuntime,
  ...
  if (delay_) {
    ...
    SetFieldValue(form_fill_env_.Get(), m_FieldName, form_control_index_,
                  strArray);
  }
  return CJS_Result::Success();
}
...
void CJS_Field::SetDelay(bool bDelay) {
  ...
  if (m_pJSDoc)
    m_pJSDoc->DoFieldDelay(m_FieldName, form_control_index_);
}

void CJS_Field::AddDelay_Int(FIELD_PROP prop, int32_t n) {
  auto pNewData =
      std::make_unique<CJS_DelayData>(prop, form_control_index_, m_FieldName);
  pNewData->num = n;
