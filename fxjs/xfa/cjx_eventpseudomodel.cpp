...
void CJX_EventPseudoModel::Property(v8::Isolate* pIsolate,
  ...
  switch (dwFlag) {
    ...
    case XFA_Event::Change:
      StringProperty(pIsolate, pValue, &pEventParam->ws_change_, bSetting);
      break;
    case XFA_Event::CommitKey:
      IntegerProperty(pIsolate, pValue, &pEventParam->commit_key_, bSetting);
      break;
    case XFA_Event::FullText:
      StringProperty(pIsolate, pValue, &pEventParam->ws_full_text_, bSetting);
      break;
    ...
    case XFA_Event::NewContentType:
      StringProperty(pIsolate, pValue, &pEventParam->ws_new_content_type_,
                     bSetting);
      break;
    case XFA_Event::NewText:
      NOTREACHED();
    case XFA_Event::PreviousContentType:
      StringProperty(pIsolate, pValue, &pEventParam->ws_prev_content_type_,
                     bSetting);
      break;
    case XFA_Event::PreviousText:
      StringProperty(pIsolate, pValue, &pEventParam->ws_prev_text_, bSetting);
      break;
    ...
    case XFA_Event::SelectionEnd:
      ...
      pEventParam->sel_end_ = std::min(
          pEventParam->sel_end_, pdfium::checked_cast<int32_t>(
                                     pEventParam->ws_prev_text_.GetLength()));
    ...
    case XFA_Event::SelectionStart:
      ...
      pEventParam->sel_start_ = std::min(
          pEventParam->sel_start_, pdfium::checked_cast<int32_t>(
                                       pEventParam->ws_prev_text_.GetLength()));
    ...
    case XFA_Event::SoapFaultCode:
      StringProperty(pIsolate, pValue, &pEventParam->ws_soap_fault_code_,
                     bSetting);
      break;
    case XFA_Event::SoapFaultString:
      StringProperty(pIsolate, pValue, &pEventParam->ws_soap_fault_string_,
                     bSetting);
      break;
