...
CFXJSE_FormCalcContext::CFXJSE_FormCalcContext(v8::Isolate* pIsolate,
                                               ...
                                               CXFA_Document* pDoc)
    : m_pIsolate(pIsolate), document_(pDoc) {
  value_.Reset(m_pIsolate,
               NewBoundV8Object(
                   m_pIsolate, CFXJSE_Class::Create(pScriptContext,
...
v8::Local<v8::Value> CFXJSE_FormCalcContext::GlobalPropertyGetter() {
  return v8::Local<v8::Value>::New(m_pIsolate, value_);
}
