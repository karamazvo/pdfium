...
CFXJSE_Class* CFXJSE_Class::Create(
  ...
  pClass->sz_class_name_ = pClassDescriptor->name;
  ...
  pClass->htemplate_.Reset(pContext->GetIsolate(), hFunctionTemplate);
...
v8::Local<v8::FunctionTemplate> CFXJSE_Class::GetTemplate(
    v8::Isolate* pIsolate) {
  return v8::Local<v8::FunctionTemplate>::New(pIsolate, htemplate_);
}
