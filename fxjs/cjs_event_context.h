...
class CJS_EventContext final : public IJS_EventContext {
 public:
  ...
  WideString& Change();
  WideString ChangeEx() const { return wide_str_change_ex_; }
  WideString SourceName() const { return str_source_name_; }
  WideString TargetName() const { return str_target_name_; }
 ...
 private:
  ...
  WideString str_source_name_;
  WideString str_target_name_;
  WideString wide_str_change_du_;
  WideString wide_str_change_ex_;
  UnownedPtr<WideString> wide_str_change_;
  int commit_key_ = -1;
  ...
  int sel_end_du_ = 0;
  int sel_start_du_ = 0;
  UnownedPtr<int> isel_end_;
  UnownedPtr<int> isel_start_;
