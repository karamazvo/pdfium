...
[[nodiscard]] bool FX_IsValidMonth(int m);
[[nodiscard]] bool FX_IsValidDay(int d);
[[nodiscard]] bool FX_IsValid24Hour(int h);
[[nodiscard]] bool FX_IsValidMinute(int m);
[[nodiscard]] bool FX_IsValidSecond(int s);
