...
//
//   page_object - handle to a page object.
//   out_active  - pointer to variable that will receive if the page object is
//                 active. This is a required parameter. Not filled if FALSE
//                 is returned.
//
// For page objects where |out_active| is filled with FALSE, the |page_object|
// is treated as if it wasn't in the document even though it is still held
// internally.
//
// Returns TRUE if the operation succeeded, FALSE if it failed.
FPDF_EXPORT FPDF_BOOL FPDF_CALLCONV
FPDFPageObj_GetIsActive(FPDF_PAGEOBJECT page_object, FPDF_BOOL* out_active);
