...
//
// The |positions| array specifies the horizontal position in points for each
// character except the first one. The first character has an implied position
// value of 0. All positions are relative to the origin of the text object.
//
