...
//
// When |active| is false, this makes the |page_object| be ignored for
// rendering and interactions with other objects on the page. It is also
// excluded when generating the contents of the page.
FPDF_EXPORT FPDF_BOOL FPDF_CALLCONV
