...
# directories. Create these first so we can run on a clean emulator.
...
adb push ${LOCAL_BUILD_DIR}/pdfium_unittests__dist/pdfium_unittests ${REMOTE_EXE_DIR}/pdfium_unittests
adb push ${LOCAL_BUILD_DIR}/pdfium_embeddertests__dist/pdfium_embeddertests ${REMOTE_EXE_DIR}/pdfium_embeddertests
