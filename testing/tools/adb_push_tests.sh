...
adb push --sync third_party/NotoSansCJK /data/local/chromium_tests_root/third_party
adb push --sync out/Android/test_fonts /data/local/tmp

# Now run the tests
adb shell /data/local/tmp/pdfium_unittests
adb shell /data/local/tmp/pdfium_embeddertests
