...
void CheckForEmptyPngData(FPDF_BITMAP bitmap, std::vector<uint8_t> png_data) {
...
void CompareBitmapToPngFile(FPDF_BITMAP bitmap,
  ...
  CheckForEmptyPngData(bitmap, png_data);
...
void EmbedderTest::CompareBitmapWithExpectationSuffix(
  ...
  // None of the candidate files exist. Call with an empty vector to trigger the error.
  CheckForEmptyPngData(bitmap, {});
}
