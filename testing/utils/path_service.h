...
class PathService {
 public:
  ...
  [[nodiscard]] static bool DirectoryExists(const std::string& path);

  // Return true when the path ends with a path separator.
  [[nodiscard]] static bool EndsWithSeparator(const std::string& path);

  // Retrieve the directory where executables run from.
  [[nodiscard]] static bool GetExecutableDir(std::string* path);
  ...
  [[nodiscard]] static bool GetSourceDir(std::string* path);
  ...
  [[nodiscard]] static bool GetTestDataDir(std::string* path);
  ...
  [[nodiscard]] static bool GetThirdPartyFilePath(const std::string& file_name,
                                                  std::string* path);
};
