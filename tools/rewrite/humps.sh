...
sed -i "s/${NO_PREFIX}${FIRST_HUMP}${MID_HUMP}${MID_HUMP}${MID_HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_\\5_\\6_/g" $FILES
sed -i "s/${NO_PREFIX}${FIRST_HUMP}${MID_HUMP}${MID_HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_\\5_/g" $FILES
sed -i "s/${NO_PREFIX}${FIRST_HUMP}${MID_HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_/g" $FILES
sed -i "s/${NO_PREFIX}${FIRST_HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_/g" $FILES
sed -i "s/${NO_PREFIX}${LAST_HUMP}/\\L\\1_\\2_/g" $FILES
