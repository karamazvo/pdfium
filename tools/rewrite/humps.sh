...
sed -i "s/${DROP_PREFIX}${HUMP}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\2_\\3_\\4_\\5_\\6_/g" $FILES
sed -i "s/${DROP_PREFIX}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\2_\\3_\\4_\\5_/g" $FILES
sed -i "s/${DROP_PREFIX}${HUMP}${HUMP}${LAST_HUMP}/\\L\\2_\\3_\\4_/g" $FILES
sed -i "s/${DROP_PREFIX}${HUMP}${LAST_HUMP}/\\L\\2_\\3_/g" $FILES
sed -i "s/${DROP_PREFIX}${LAST_HUMP}/\\L\\2_/g" $FILES

sed -i "s/${LC_PREFIX}${HUMP}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_\\5_\\6_/g" $FILES
sed -i "s/${LC_PREFIX}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_\\5_/g" $FILES
sed -i "s/${LC_PREFIX}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_/g" $FILES
sed -i "s/${LC_PREFIX}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_/g" $FILES
sed -i "s/${LC_PREFIX}${LAST_HUMP}/\\L\\1_\\2_/g" $FILES

sed -i "s/${NO_PREFIX}${HUMP}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_\\5_/g" $FILES
sed -i "s/${NO_PREFIX}${HUMP}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_\\4_/g" $FILES
sed -i "s/${NO_PREFIX}${HUMP}${HUMP}${LAST_HUMP}/\\L\\1_\\2_\\3_/g" $FILES
sed -i "s/${NO_PREFIX}${HUMP}${LAST_HUMP}/\\L\\1_\\2_/g" $FILES
