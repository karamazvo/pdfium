...
sed -i 's/\bm_\(p\|b\|e\|n\|i\|dw\|ws\|bs\|cr\|sz\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\2_\3_\4_\5_\6_/g' $FILES
sed -i 's/\bm_\(p\|b\|e\|n\|i\|dw\|ws\|bs\|cr\|sz\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\2_\3_\4_\5_/g' $FILES
sed -i 's/\bm_\(p\|b\|e\|n\|i\|dw\|ws\|bs\|cr\|sz\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\2_\3_\4_/g' $FILES
sed -i 's/\bm_\(p\|b\|e\|n\|i\|dw\|ws\|bs\|cr\|sz\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\2_\3_/g' $FILES
sed -i 's/\bm_\(p\|b\|e\|n\|i\|dw\|ws\|bs\|cr\|sz\)\([A-Z0-9]\+[a-z]*\)\b/\L\2_/g' $FILES

sed -i 's/\bm_\([A-Za-z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\1_\2_\3_\4_\5_/g' $FILES
sed -i 's/\bm_\([A-Za-z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\1_\2_\3_\4_/g' $FILES
sed -i 's/\bm_\([A-Za-z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\1_\2_\3_/g' $FILES
sed -i 's/\bm_\([A-Za-z0-9]\+[a-z]\+\)\([A-Z0-9]\+[a-z]*\)\b/\L\1_\2_/g' $FILES
sed -i 's/\bm_\([A-Za-z0-9]\+[a-z]*\)\b/\L\1_/g' $FILES
