...
class CXFA_EventParam {
 public:
  ...
  WideString ws_result_;
  WideString ws_change_;
  WideString ws_full_text_;
  WideString ws_new_content_type_;
  WideString ws_prev_content_type_;
  WideString ws_prev_text_;
  WideString ws_soap_fault_code_;
  WideString ws_soap_fault_string_;
};
