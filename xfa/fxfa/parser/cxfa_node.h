...
class CXFA_Node : public CXFA_Object, public GCedTreeNodeMixin<CXFA_Node> {
 public:
  ...
  uint32_t GetNameHash() const { return dw_name_hash_; }
  bool IsUnnamed() const { return dw_name_hash_ == 0; }
 ...
 private:
  ...
  Mask<XFA_NodeFlag> unode_flags_ = XFA_NodeFlag::kNone;
  uint32_t dw_name_hash_ = 0;
