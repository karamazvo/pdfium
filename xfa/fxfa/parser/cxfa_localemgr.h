...
class CXFA_LocaleMgr final : public cppgc::GarbageCollected<CXFA_LocaleMgr>,
 ...
 private:
  ...
  // 1. we might never have tried to determine |ws_config_locale_|.
  ...
  // and |ws_config_locale_| is the possibly nothing we got if we tried.
  mutable std::optional<WideString> ws_config_locale_;
