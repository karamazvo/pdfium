...
bool CXFA_FFComboBox::CommitData() {
  return node_->SetValue(XFA_ValuePicture::kRaw, ws_new_value_);
}
...
void CXFA_FFComboBox::OnTextChanged(CFWL_Widget* pWidget,
  ...
  eParam.ws_prev_text_ = node_->GetValue(XFA_ValuePicture::kRaw);
  eParam.ws_change_ = wsChanged;
