 ...
 private:
  class Context {
   ...
   public:
    ...
    std::optional<float> fcur_column_width_;
    UnownedPtr<std::vector<float>> rg_specified_column_widths_;
  ...
  float fused_size_ = 0;
  float flast_row_width_ = 0;
  float flast_row_y_ = 0;
  float fwidth_limit_ = 0;
