...
class CFGAS_Break {
 public:
  ...
  Mask<LayoutStyle> GetLayoutStyles() const { return dw_layout_styles_; }
 ...
 protected:
  ...
  Mask<LayoutStyle> dw_layout_styles_ = LayoutStyle::kNone;
  uint32_t dw_identity_ = 0;
  int32_t line_start_ = 0;
  int32_t line_width_ = 2000000;
  wchar_t wparagraph_break_char_ = L'\n';
