...
class CFGAS_BreakPiece {
 public:
  ...
  CFGAS_Char::BreakType GetStatus() const { return dw_status_; }
  void SetStatus(CFGAS_Char::BreakType status) { dw_status_ = status; }
  ...
  uint32_t GetCharStyles() const { return dw_char_styles_; }
  void SetCharStyles(uint32_t styles) { dw_char_styles_ = styles; }
 ...
 private:
  CFGAS_Char::BreakType dw_status_ = CFGAS_Char::BreakType::kPiece;
