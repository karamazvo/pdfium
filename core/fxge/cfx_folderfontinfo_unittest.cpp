...
class CFXFolderFontInfoTest : public ::testing::Test {
 public:
  CFXFolderFontInfoTest() {
    AddDummyFont(kArial, CFX_FolderFontInfo::FontFaceInfo::CharsetFlags::kAnsi);
    AddDummyFont(kCourierNew,
                 CFX_FolderFontInfo::FontFaceInfo::CharsetFlags::kAnsi);
    AddDummyFont(kTimesNewRoman,
                 CFX_FolderFontInfo::FontFaceInfo::CharsetFlags::kNone);
    AddDummyFont(kBookshelfSymbol7,
                 CFX_FolderFontInfo::FontFaceInfo::CharsetFlags::kSymbol);
 ...
 private:
  void AddDummyFont(const char* font_name,
                    CFX_FolderFontInfo::FontFaceInfo::CharsetFlags charsets) {
