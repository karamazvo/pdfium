...
TEST_F(CFXFolderFontInfoTest, TestFindFont) {
  ...
  void* font = FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kSymbol,
                        pdfium::FontPitchFamily::kPitchFamilyRoman, kSymbol,
                        /*bMatchName=*/true);
  ASSERT_TRUE(font);
  ...
  EXPECT_FALSE(FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kSymbol,
                        pdfium::FontPitchFamily::kPitchFamilyRoman, kCalibri,
                        /*bMatchName=*/true));
  ...
  font = FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kSymbol,
                  pdfium::FontPitchFamily::kPitchFamilyRoman, kBookshelf,
                  /*bMatchName=*/true);
  ASSERT_TRUE(font);
  ...
  font = FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kANSI,
                  pdfium::FontPitchFamily::kPitchFamilyRoman, kLato,
                  /*bMatchName=*/true);
  ASSERT_TRUE(font);
  ...
  font = FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kANSI,
                  pdfium::FontPitchFamily::kPitchFamilyRoman, kOxygen,
                  /*bMatchName=*/true);
  ASSERT_TRUE(font);
  ...
  font = FindFont(/*weight=*/0, /*bItalic=*/false, FX_Charset::kANSI,
                  pdfium::FontPitchFamily::kPitchFamilyRoman, kOxygenSans,
                  /*bMatchName=*/true);
  ASSERT_TRUE(font);
  EXPECT_EQ(GetFaceName(font), kOxygenSansSansBold);
  ...
  font =
      FindFont(700, false, FX_Charset::kANSI,
               pdfium::FontPitchFamily::kPitchFamilyFixed, kComicSansMS, true);
  ASSERT_TRUE(font);
