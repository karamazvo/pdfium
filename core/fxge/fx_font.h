...
enum FontPitchFamily {
  kPitchFamilyFixed = 1 << 0,
  kPitchFamilyRoman = 1 << 4,
  kPitchFamilyScript = 1 << 6,
};
...
inline bool FontFamilyIsFixedPitch(uint32_t family) {
  return !!(family & pdfium::FontPitchFamily::kPitchFamilyFixed);
}
inline bool FontFamilyIsRoman(uint32_t family) {
  return !!(family & pdfium::FontPitchFamily::kPitchFamilyRoman);
}
inline bool FontFamilyIsScript(int32_t family) {
  return !!(family & pdfium::FontPitchFamily::kPitchFamilyScript);
}
