...
fxcrt::Mask<CFX_FolderFontInfo::FontFaceInfo::CharsetFlags>
CFX_FolderFontInfo::FontFaceInfo::GetCharset(FX_Charset charset) {
  switch (charset) {
    case FX_Charset::kShiftJIS:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kShiftJis};
    case FX_Charset::kChineseSimplified:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kGb};
    case FX_Charset::kChineseTraditional:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kBig5};
    case FX_Charset::kHangul:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kKorean};
    case FX_Charset::kSymbol:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kSymbol};
    case FX_Charset::kANSI:
      return fxcrt::Mask<CharsetFlags>{CharsetFlags::kAnsi};
    default:
      break;
  }
  return fxcrt::Mask<CharsetFlags>{};
}
...
void* CFX_FolderFontInfo::FindFont(int weight,
  ...
  fxcrt::Mask<FontFaceInfo::CharsetFlags> charset_flag =
      FontFaceInfo::GetCharset(charset);
