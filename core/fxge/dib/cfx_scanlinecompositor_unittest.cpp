...
TEST(ScanlineCompositorTest, CompositeRgbBitmapLineBgraNormal) {
  ...
  RunTest(compositor, pdfium::as_byte_span(kSrcScan1), kExpectations1);
  ...
  RunTest(compositor, pdfium::as_byte_span(kSrcScan2), kExpectations2);
  ...
  RunTest(compositor, pdfium::as_byte_span(kSrcScan3), kExpectations3);
}
