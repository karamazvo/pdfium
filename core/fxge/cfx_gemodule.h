...
class CFX_GEModule {
 public:
  ...
  static CFX_FontMgr* GetFontMgr() const { return Get()->font_mgr_.get(); }
  static PlatformIface* GetPlatform() const { return Get()->platform_.get(); }
  static const char** GetUserFontPaths() const {
    return Get()->user_font_paths_;
  }
