...
void CryptSha256Finish(CryptSha2Context* context,
  ...
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[0]), digest, 0);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[1]), digest, 4);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[2]), digest, 8);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[3]), digest, 12);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[4]), digest, 16);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[5]), digest, 20);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[6]), digest, 24);
  SHA_PUT_UINT32(static_cast<uint32_t>(context->state[7]), digest, 28);
}
