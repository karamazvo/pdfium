...
TEST(FXCryptShaTest, Sha1) {
  ...
  for (const auto& test : kTests) {
    DataVector<uint8_t> actual = CryptSha1Generate(
        pdfium::as_bytes(pdfium::span(std::string(test.input))));
...
TEST(FXCryptShaTest, Sha512BlockBoundary127) {
  ...
  DataVector<uint8_t> actual =
      CryptSha512Generate(pdfium::as_bytes(pdfium::span(input)));
  EXPECT_THAT(
      actual,
...
TEST(FXCryptShaTest, Sha1Streaming) {
  ...
  CryptSha1Update(&ctx, pdfium::as_bytes(pdfium::span(p1)));
  CryptSha1Update(&ctx, pdfium::as_bytes(pdfium::span(p2)));
  CryptSha1Update(&ctx, pdfium::as_bytes(pdfium::span(p3)));
...
TEST(FXCryptShaTest, Sha256Streaming) {
  ...
  CryptSha256Update(&ctx, pdfium::as_bytes(pdfium::span(p1)));
  CryptSha256Update(&ctx, pdfium::as_bytes(pdfium::span(p2)));
  CryptSha256Update(&ctx, pdfium::as_bytes(pdfium::span(p3)));
...
TEST(FXCryptShaTest, Sha384Streaming) {
  ...
  CryptSha384Update(&ctx, pdfium::as_bytes(pdfium::span(p1)));
  CryptSha384Update(&ctx, pdfium::as_bytes(pdfium::span(p2)));
  CryptSha384Update(&ctx, pdfium::as_bytes(pdfium::span(p3)));
...
TEST(FXCryptShaTest, Sha512Streaming) {
  ...
  CryptSha512Update(&ctx, pdfium::as_bytes(pdfium::span(p1)));
  CryptSha512Update(&ctx, pdfium::as_bytes(pdfium::span(p2)));
  CryptSha512Update(&ctx, pdfium::as_bytes(pdfium::span(p3)));
...
TEST(FXCryptShaTest, Sha1Multilingual) {
  ...
  CryptSha1Update(&ctx, pdfium::as_bytes(pdfium::span(input)));
...
TEST(FXCryptShaTest, Sha256Multilingual) {
  ...
  std::string input = "AI is 爱";
  CryptSha256Update(&ctx, pdfium::as_bytes(pdfium::span(input)));
...
TEST(FXCryptShaTest, Sha384Multilingual) {
  ...
  std::string input = "AI is 爱";
  CryptSha384Update(&ctx, pdfium::as_bytes(pdfium::span(input)));
...
TEST(FXCryptShaTest, Sha512Multilingual) {
  ...
  std::string input = "AI is 爱";
  CryptSha512Update(&ctx, pdfium::as_bytes(pdfium::span(input)));
