...
std::optional<int> CountPages(
  ...
  // Don't trust /Count — it may not match the actual number of valid kids
  // (e.g. when /Kids contains null object references). Always validate by
  // counting from the /Kids array below.
