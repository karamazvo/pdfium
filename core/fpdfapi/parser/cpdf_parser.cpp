...
<<<<<<< PATCH SET (9d0e36b2b4f659028b4e98b507af4e72e0f88459 Ensure AddCompressed and SetFree fail gracefully in CPDF_Cro)
...
||||||| BASE      (97fbf9a309923abd1af616cfa08da60c1adeb9d2 Fail gracefully on invalid cross-ref entries)
      if (!cross_ref_table->AddNormal(obj_num, gen_num,
                                      /*is_object_stream=*/false, obj_pos)) {
        return false;
      }
...
>>>>>>> BASE      (80066750f4707c39fb9d14b0a48a249bb04d13d8 Improve bitmap comparison failure reporting in embedder test)
        }
      }
    }
    numbers.clear();
