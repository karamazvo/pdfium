...
// Abstract interface used by the `libpng`-based decoder from
// `libpng_png_decoder.h` and from `skia_png_decoder.cpp`.
class PngDecoderDelegate {
 public:
  ...
  // * `bits_per_component` and `number_of_components` describe the format
