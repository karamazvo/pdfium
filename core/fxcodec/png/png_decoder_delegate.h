...
class PngDecoderDelegate {
 public:
  ...
  // Called by `PngDecoder` to ask where to write decoded RGBA/8 pixels.
  // Implementation should return a span to the buffer where decoder can
  // write decoded pixels from the given `line`.
  //
  ...
  // Called by `PngDecoder` to ask where to write decoded RGBA/8 pixels.
  // Implementation should return a span to the buffer where the pixels
  // of the decoded image can be written to.
