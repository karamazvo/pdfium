...
class CJBig2_HuffmanTable {
 public:
  ...
  [[nodiscard]] bool IsHTOOB() const { return HTOOB; }
 ...
 private:
  [[nodiscard]] bool ParseFromStandardTable(size_t table_idx);
  [[nodiscard]] bool ParseFromCodedBuffer(CJBig2_BitStream* pStream);
