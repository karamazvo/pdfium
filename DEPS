...
vars = {
  ...
  'abseil_revision': 'ed3733b91e472a1e7a641c1f0c1e6c0ea698e958',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'build_revision': 'b677f61e34f668177b05d98ad01ccbc33c509d58',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'clang_revision': '63b7be17f8981d716ea9a0d65bb04654d79548a8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'tools_rust_revision': 'a69a8ecdbf7a19fb129ae57650cac9f704cb7cf9',
  # Three lines of non-changing comments so that
