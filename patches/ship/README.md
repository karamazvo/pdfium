...
blind numeric globbing. For `r25-3-0115`, apply the r25 rendering base through
0031, then only 0051, 0075, 0076, and 0092 through 0115:
...
`r25-3-0115` build. The machine-checked list lives in the 0115 workflow.
