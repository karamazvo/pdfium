...
blind numeric globbing. For `r25-2-0100`, apply the r25 rendering base through
0031, then only 0051, 0075, 0076, and 0092 through 0100:
...
`r25-2-0100` build. The machine-checked list lives in the 0100 workflow.
